            ...
            <li className="drop-shadow-2xl">
              ...
              >
                <IconButton
                  ...
                  className="inline-flex items-center border bg-transparent py-2 px-4 text-center font-bold uppercase hover:bg-gray-700"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="leading-lg h-5 w-5 pr-1 text-lg text-slate-50 opacity-75"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
