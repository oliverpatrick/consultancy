    ...
    <Main meta={<Meta title="Tom Rosik" description="Enter your SEO" />}>
        ...
        <div className="container m-8 mx-auto max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row">
            <div className="p-6 text-center sm:w-1/2">
              <h3 className="mb-3 break-words bg-gradient-to-r from-pink-500 to-violet-500 bg-clip-text stroke-slate-100 text-3xl font-extrabold leading-none text-transparent">
          ...
          <div className="flex flex-col-reverse sm:flex-row">
            <div className="mt-6 w-full p-6 sm:w-5/6">
              <svg className="mx-auto w-1/2" viewBox="0 0 36 36">
      ...
      <section className="container mx-auto mb-12 py-6 text-center">
        <h1 className="my-2 w-full text-5xl font-bold leading-tight text-gray-400">
          <span className="bg-gradient-to-r from-pink-500 to-violet-500 bg-clip-text stroke-slate-100 text-5xl font-extrabold uppercase text-transparent">
            Get in touch
          </span>
        </h1>
        <div className="mb-4 w-full">
        ...
        <h3 className="my-4 break-words text-xl">Email: opphdev@gmail.com</h3>
        <a href="mailto:opphdev@gmail.com">
          <IconButton className="focus:shadow-outline mx-auto my-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 py-4 px-8 font-bold text-white shadow-lg transition duration-300 ease-in-out hover:scale-105 hover:underline focus:outline-none lg:mx-0">
            Contact
          </IconButton>
        </a>
      </section>
